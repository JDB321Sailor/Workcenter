...
const packageUrl = 'https://raw.githubusercontent.com/JDB321Sailor/Workcenter/Dev/package.json';
...
const makeMsg = (latestVersion) => {
  ...
  if (difference <= 0) {
    return '\x1b[1m\x1b[32m✅ Workcenter is Up-to-Date\x1b[0m\n';
  }
...
const runCheck = async () => {
  ...
  try {
    ...
    logToConsole(`\nUsing Workcenter V-${currentVersion}. Update Check Complete`);
