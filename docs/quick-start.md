...
> Everything in this directory is served from Workcenter's root (e.g. `/app/user-data/logo.png` will be accessible at `http://[workcenter.local]/logo.png`).
...
For example, if you had `user-data/favicon.ico` this would be accessible at `http://my-workcenter-instance.local/favicon.ico`
...
- `initialization.html` - Static HTML page displayed before the app has finished compiling, see [`public/initialization.html`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/public/initialization.html)
...
- `**.html` - Write your own HTML pages, and access them at `http://my-workcenter-instance.local/my-page.html`
- `fonts/` - Custom fonts (be sure to include the ones already in [`public/fonts`](https://github.com/JDB321Sailor/Workcenter/tree/Dev/public/fonts)
...
Config is written in [YAML Format](https://yaml.org/), and saved in [`/user-data/conf.yml`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/user-data/conf.yml).
The format on the config file is pretty straight forward. There are four root attributes:

- [`pageInfo`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/configuring.md#pageinfo) - Dashboard meta data, like title, description, nav bar links and footer text
- [`appConfig`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/configuring.md#appconfig-optional) - Dashboard settings, like themes, authentication, language and customization
- [`sections`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/configuring.md#section) - An array of sections, each including an array of items
- [`pages`](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/configuring.md#pages-optional) - Have multiples pages in your dashboard

You can view a full list of all available config options in the [Configuring Docs](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/configuring.md).
...
Once you've got Workcenter setup, you'll want to ensure the container is properly healthy, secured, backed up and kept up-to-date. All this is covered in the [Management Docs](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/management.md).
...
If you need any help or support in getting Workcenter running, head over to the [Discussions](https://github.com/JDB321Sailor/Workcenter/discussions) page. If you think you've found a bug, please do [raise it](https://github.com/JDB321Sailor/Workcenter/issues/new/choose) so it can be fixed. For contact options, see the `.github/SUPPORT.md`.

If you're enjoying Workcenter, and have a few minutes to spare, please do take a moment to look at the [Contributing Page](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/contributing.md). Huge thanks to [everyone](https://github.com/JDB321Sailor/Workcenter/blob/Dev/docs/credits.md) who has already helped out!
...
```bash
git clone https://github.com/JDB321Sailor/Workcenter.git && cd workcenter
...
- [<img src="https://i.ibb.co/ZxtzrP3/netlify.png" width="18"/> Deploy to Netlify](https://app.netlify.com/start/deploy?repository=https://github.com/JDB321Sailor/Workcenter)
- [<img src="https://i.ibb.co/d2P1WZ7/heroku.png" width="18"/> Deploy to Heroku](https://heroku.com/deploy?template=https://github.com/JDB321Sailor/Workcenter)
- [<img src="https://i.ibb.co/Ld2FZzb/vercel.png" width="18"/> Deploy to Vercel](https://vercel.com/new/project?template=https://github.com/JDB321Sailor/Workcenter)
- [<img src="https://i.ibb.co/xCHtzgh/render.png" width="18"/> Deploy to Render](https://render.com/deploy?repo=https://github.com/JDB321Sailor/Workcenter/Dev/tree/deploy_render)
- [<img src="https://i.ibb.co/J7MGymY/googlecloud.png" width="18"/> Deploy to GCP](https://deploy.cloud.run/?git_repo=https://github.com/JDB321Sailor/Workcenter.git)
- [<img src="https://i.ibb.co/HVWVYF7/docker.png" width="18"/> Deploy to PWD](https://labs.play-with-docker.com/?stack=https://raw.githubusercontent.com/JDB321Sailor/Workcenter/Dev/docker-compose.yml)
- [<img src="https://i.ibb.co/7NxnM2P/easypanel.png" width="18"/> Deploy to Easypanel](https://easypanel.io/docs/templates/workcenter)
