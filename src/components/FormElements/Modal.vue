  ...
  <teleport to="body">
    ...
    >
      <dialog
        ...
        :class="['workcenter-modal', classes, { resizable }]"
        :style="{ width, height }"
      >
  ...
  methods: {
    open() {
      ...
      try {
        ...
        const root = document.getElementById('workcenter');
    ...
    teardown() {
      ...
      document.getElementById('workcenter')?.removeAttribute('inert');
