...
/** Check if a request URL targets the local Workcenter server */
...
function reportBearerIssue(reason) {
  ...
  const messages = {
    ...
    'encrypted-jwe': 'SSO token is encrypted. Workcenter needs signed JWT tokens, not encrypted JWE tokens.',
