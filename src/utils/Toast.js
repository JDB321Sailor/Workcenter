/**
 * Workcenter's $toast plugin, for action/toast notifications
 *
...
const CONTAINER_ID = 'workcenter-toasts';
...
function injectStyles() {
  ...
  style.id = 'workcenter-toast-styles';
  style.textContent = `
    #${CONTAINER_ID} {
      position: fixed;
      bottom: 1rem;
    ...
    .workcenter-toast.is-visible {
      opacity: 1;
      transform: translateY(0);
      }
    .workcenter-toast.is-leaving {
      opacity: 0;
    }
    .workcenter-toast--success {
      background: var(--success);
      border-color: transparent;
      color: #fff;
    }
    .workcenter-toast--error {
      background: var(--danger);
      border-color: transparent;
      color: #fff;
    }
    .workcenter-toast--warning {
      background: var(--warning);
      border-color: transparent;
      color: #fff;
    }
    .workcenter-toast__msg {
      flex: 1;
      min-width: 0;
      overflow-wrap: break-word;
    }
    .workcenter-toast__action,
    .workcenter-toast__close {
    ...
    .workcenter-toast__action:hover,
    .workcenter-toast__action:focus-visible {
      background: rgba(255, 255, 255, 0.15);
    }
    .workcenter-toast__close:hover,
    .workcenter-toast__close:focus-visible {
      opacity: 1;
    }
...
function show(message, opts = {}) {
  ...
  el.className = `workcenter-toast workcenter-toast--${cfg.type}`;
  ...
  msg.className = 'workcenter-toast__msg';
  ...
  if (cfg.action?.text) {
    ...
    btn.type = 'button';
    btn.className = 'workcenter-toast__action';
  ...
  if (needsClose) {
    ...
    close.type = 'button';
    close.className = 'workcenter-toast__close';
