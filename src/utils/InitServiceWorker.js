...
const AUTH_PROXY_COMPAT_KEY = 'workcenter-auth-proxy-compat'; // mirrors appConfig.enableAuthProxyCompat
const AUTH_PROXY_RELOAD_KEY = 'workcenter-auth-proxy-reloaded'; // one reload per tab, guards against loops
